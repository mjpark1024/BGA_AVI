...
{
    class ToolNumberMark : ToolRectangleBase
    {
        #region Ctor.
        public ToolNumberMark()
        {
        ...
        public override void OnMouseDown(DrawingCanvas drawingCanvas, MouseButtonEventArgs e)
        {
            ...
            GraphicsNumberMark graphic =
                new GraphicsNumberMark(p.X, p.Y, p.X + 1, p.Y + 1,
                                      drawingCanvas.LineWidth,
                                      drawingCanvas.ObjectColor,
                                      drawingCanvas.ActualScale, 0, str, GraphicsRegionType.MarkingReject, null);
            // Add this Rectangle to GraphicList of drawingCanvas.
            NumberProperty rc = new NumberProperty();
            graphic.MarkInfo = new MarkItem(MarkingType.GetMarkType(eMarkingType.eMarkingNumber), rc, 0);
