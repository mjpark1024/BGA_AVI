...
{
    class ToolTriangleMark : ToolRectangleBase
    {
        //private eMarkSection section;
        #region Ctor.
        public ToolTriangleMark()
        {
            //section = option;
        ...
        public override void OnMouseDown(DrawingCanvas drawingCanvas, MouseButtonEventArgs e)
        {
            ...
            GraphicsTriangleMark graphic = new GraphicsTriangleMark(p.X, p.Y, p.X + 1, p.Y + 1,
                                      drawingCanvas.LineWidth,
                                      drawingCanvas.ObjectColor,
                                      drawingCanvas.ActualScale,false, false,str, 0, GraphicsRegionType.MarkingUnit);

            // Add this Rectangle to GraphicList of drawingCanvas.
            UnitTriProperty rc = new UnitTriProperty();
            graphic.MarkInfo = new MarkItem(MarkingType.GetMarkType(eMarkingType.eMarkingUnitTri), rc, 0);
