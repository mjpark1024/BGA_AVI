...
{
    class ToolWeekMark : ToolRectangleBase
    {
        #region Ctor.
        public ToolWeekMark()
        {
        ...
        public override void OnMouseDown(DrawingCanvas drawingCanvas, MouseButtonEventArgs e)
        {
            ...
            GraphicsWeekMark graphic =
                new GraphicsWeekMark(p.X, p.Y, p.X + 1, p.Y + 1,
            ...
            WeekProperty rc = new WeekProperty();
            graphic.MarkInfo = new MarkItem(MarkingType.GetMarkType(eMarkingType.eMarkingWeek), rc, 0);
