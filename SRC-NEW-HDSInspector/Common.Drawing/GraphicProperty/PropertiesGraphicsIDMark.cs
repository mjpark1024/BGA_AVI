...
{
    public class PropertiesGraphicsIDMark : PropertiesGraphicsBase
    {
        private double left;
        private double top;
        ...
        #region Ctor.
        // For XmlSerializer
        public PropertiesGraphicsIDMark()
        {
            // XML로의 저장을 위해 기본 생성자가 필요하다.
        }

        public PropertiesGraphicsIDMark(GraphicsIDMark rectangle)
        {
            if (rectangle == null)
            {
        ...
        public override GraphicsBase CreateGraphics()
        {
            ...
            GraphicsIDMark b = new GraphicsIDMark(left, top, right, bottom, lineWidth, objectColor,
