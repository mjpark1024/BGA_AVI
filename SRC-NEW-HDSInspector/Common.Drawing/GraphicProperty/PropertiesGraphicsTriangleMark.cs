...
{
    public class PropertiesGraphicsTriangleMark : PropertiesGraphicsBase
    {
        private double left;
        private double top;
        ...
        #region Ctor.
        // For XmlSerializer
        public PropertiesGraphicsTriangleMark()
        {
            // XML로의 저장을 위해 기본 생성자가 필요하다.
        }

        public PropertiesGraphicsTriangleMark(GraphicsTriangleMark rectangle)
        {
            if (rectangle == null)
            {
                throw new ArgumentNullException("trianglemark");
            }
        ...
        public override GraphicsBase CreateGraphics()
        {
            ...
            GraphicsTriangleMark b = new GraphicsTriangleMark(left, top, right, bottom, lineWidth, objectColor,
                                                   actualScale, motherROIID, caption, white, dummy, rotate, markinfo, regiontype);
