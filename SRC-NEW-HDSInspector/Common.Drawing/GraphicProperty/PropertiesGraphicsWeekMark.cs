...
{
    public class PropertiesGraphicsWeekMark : PropertiesGraphicsBase
    {
        private double left;
        private double top;
        ...
        #region Ctor.
        // For XmlSerializer
        public PropertiesGraphicsWeekMark()
        {
            // XML로의 저장을 위해 기본 생성자가 필요하다.
        }

        public PropertiesGraphicsWeekMark(GraphicsWeekMark rectangle)
        {
            if (rectangle == null)
            {
                throw new ArgumentNullException("weekmark");
            }
        ...
        public override GraphicsBase CreateGraphics()
        {
            ...
            GraphicsWeekMark b = new GraphicsWeekMark(left, top, right, bottom, lineWidth, objectColor,
