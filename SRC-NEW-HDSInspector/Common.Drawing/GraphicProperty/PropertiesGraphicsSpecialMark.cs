...
{
    public class PropertiesGraphicsSpecialMark : PropertiesGraphicsBase
    {
        private double left;
        private double top;
        ...
        #region Ctor.
        // For XmlSerializer
        public PropertiesGraphicsSpecialMark()
        {
            // XML로의 저장을 위해 기본 생성자가 필요하다.
        }

        public PropertiesGraphicsSpecialMark(GraphicsSpecialMark rectangle)
        {
            if (rectangle == null)
            {
                throw new ArgumentNullException("specialmark");
            }
        ...
        public override GraphicsBase CreateGraphics()
        {
            ...
            GraphicsTriangleMark b = new GraphicsTriangleMark(left, top, right, bottom, lineWidth, objectColor,
                                                   actualScale, motherROIID, caption, white, dummy, shape, markinfo, regiontype);
