...
{
    public class PropertiesGraphicsNumberMark : PropertiesGraphicsBase
    {
        private double left;
        private double top;
        ...
        private MarkLogo logo;

        #region Ctor.
        // For XmlSerializer
        public PropertiesGraphicsNumberMark()
        {
            // XML로의 저장을 위해 기본 생성자가 필요하다.
        }

        public PropertiesGraphicsNumberMark(GraphicsNumberMark rectangle)
        {
            if (rectangle == null)
            {
                throw new ArgumentNullException("numbermark");
            }
        ...
        public override GraphicsBase CreateGraphics()
        {
            ...
            GraphicsNumberMark b = new GraphicsNumberMark(left, top, right, bottom, lineWidth, objectColor,
                                                   actualScale, 0,  caption, "", markinfo, regiontype, logo);
