...
{
    public class GraphicsIDMark : GraphicsRectangleBase
    {
        ...
        public GraphicsIDMark(double left, double top, double right, double bottom, double lineWidth, Color objectColor, double actualScale, double rotate, string mID, GraphicsRegionType regiontype)
        ...
        public GraphicsIDMark(double left, double top, double right, double bottom,
                                 double lineWidth,
                                 Color objectColor,
                                 double actualScale,
                                 double rotate,
        ...
        public override void Draw(DrawingContext drawingContext)
        {
            ...
            drawingContext.DrawText(CreateIDString(height), new Point(startPoint.X, startPoint.Y));
        ...
        {
            return new PropertiesGraphicsIDMark(this);
        }
        #endregion Overrides
