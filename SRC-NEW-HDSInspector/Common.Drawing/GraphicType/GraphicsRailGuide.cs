...
{
    public class GraphicsRailGuide : GraphicsRectangleBase
    {
 #region Constructors
        public GraphicsRailGuide(double left, double top, double right, double bottom, double lineWidth, Color objectColor, double actualScale)
        {
            ...
            // Guide Line.
            this.graphicsRegionType = GraphicsRegionType.RailGuide;
            this.caption = CaptionHelper.RailGuideCaption;
            this.MarkID = "";
            RefreshDrawing();
        }
        ...
        {
            return new PropertiesGraphicsRailGuide(this);
        }
        #endregion Overrides
